...
pub fn build() {
    ...
    // # Base: create table, insert, select
    {
        ...
        generate(Some("sqlite_gen_base_insert"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Primary key
    {
        ...
        generate(Some("sqlite_gen_constraint"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: i32
    {
        ...
        generate(Some("sqlite_gen_param_i32"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: datetime (seconds) (chrono)
    {
        ...
        generate(Some("sqlite_gen_param_utctime_s_chrono"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: datetime (ms) (chrono)
    {
        ...
        generate(Some("sqlite_gen_param_utctime_ms_chrono"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: datetime (seconds) (jiff)
    {
        ...
        generate(Some("sqlite_gen_param_utctime_s_jiff"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: datetime (ms) (jiff)
    {
        ...
        generate(Some("sqlite_gen_param_utctime_ms_jiff"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        generate(Some("sqlite_gen_query_like"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_is_null"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_concat"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_row_number"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: Opt`<i32>`
    {
        ...
        generate(Some("sqlite_gen_param_opt_i32"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: Opt`<i32>`, null
    {
        ...
        let bananna = v.table("bananna");
        let hizat = bananna.field("hizat", field_i32().opt().build());
        generate(Some("sqlite_gen_param_opt_i32_null"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: All custom types
    {
        ...
        generate(Some("sqlite_gen_param_custom"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # (insert) Param: Opt`<Custom>`
    {
        ...
        generate(Some("sqlite_gen_param_opt_custom"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Update
    {
        ...
        let bananna = v.table("bananna");
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_update"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Update, where
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_update_where"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Update, returning
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_update_returning"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Delete
    {
        ...
        let bananna = v.table("b");
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_delete"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Delete, where
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_delete_where"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Delete, returning
    {
        ...
        let bananna = v.table("b");
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_delete_returning"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Select limit
    {
        ...
        let bananna = v.table("bannanana");
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_select_limit"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Select order
    {
        ...
        let bananna = v.table("bannanana");
        let hizat = bananna.field("hizat", field_i32().build());
        generate(Some("sqlite_gen_select_order"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Select group
    {
        ...
        generate(Some("sqlite_gen_select_group_by"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Migrate - remove field
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_migrate_remove_field"), vec![
            // Versions (previous)
            (0usize, {
                let v = SqliteVersion::new();
                let bananna = v.table("bnanaa");
    ...
    // # Migrate - rename table
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_migrate_rename_table"), vec![
            // Versions (previous)
            (0usize, {
                let v = SqliteVersion::new();
    ...
    // # Migrate - remove table
    {
        ...
        generate(Some("sqlite_gen_migrate_remove_table"), vec![
            // Versions (previous)
            (0usize, {
                let v = SqliteVersion::new();
                let bananna = v.table("bananana");
    ...
    // # Junction
    {
        ...
        let hizat = bananna.field("hizat", field_i32().build());
        let hizat2 = bananna.field("hizat2", field_i32().build());
        generate(Some("sqlite_gen_select_junction"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Select CTE
    {
        ...
        generate(Some("sqlite_gen_select_cte"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Window function
    {
        ...
        let hizat = bananna.field("hizat", field_i32().build());
        let hizat2 = bananna.field("hizat2", field_i32().build());
        generate(Some("sqlite_gen_select_window"), vec![(1usize, v.build())]).unwrap();
    }
    ...
    // # Param array
    {
        ...
        let bananna = v.table("bananna");
        let hizat = bananna.field("hizat", field_i32().build());
        generate(Some("sqlite_gen_param_arr_i32"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        generate(Some("sqlite_gen_query_filter"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let _hizat = bananna.field("hizat", field_str().build());
        let _two = bananna.field("two", field_i32().build());
        generate(Some("sqlite_gen_query_window_frame"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_collate"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        generate(Some("sqlite_gen_query_is_distinct_from"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let _hizat = bananna.field("hizat", field_str().build());
        let _two = bananna.field("two", field_i32().build());
        generate(Some("sqlite_gen_query_having"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_glob"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        let _ = bananna.index("bananna_hizat", &[&_hizat]);
        generate(Some("sqlite_gen_query_indexed_by"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_cte_subquery"), vec![(1usize, v.build())]).unwrap();
    }

    {
        ...
        let bananna = v.table("bananna");
        let _hizat = bananna.field("hizat", field_str().build());
        generate(Some("sqlite_gen_query_like_escape"), vec![(1usize, v.build())]).unwrap();
    }
}
