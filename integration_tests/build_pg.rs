...
pub fn build() {
    // # Base: create table, insert, select
    {
        ...
        generate(Some("pg_gen_base_insert"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # (insert) Param: i32
    {
        ...
        generate(Some("pg_gen_param_i32"), vec![(1usize, v.build())], vec![]).unwrap();
    }

    // # (insert) Param: utctime (chrono)
    {
        let v = PgVersion::new();
        let bananna = v.table("param_utctime_chrono_bananna");
        let hizat = bananna.field("hizat", field_utctime_s_chrono().build());
        generate(Some("pg_gen_param_utctime_chrono"), vec![(1usize, v.build())], vec![]).unwrap();
    }

    // # (insert) Param: utctime (jiff)
    {
        let v = PgVersion::new();
        let bananna = v.table("param_utctime_jiff_bananna");
        let hizat = bananna.field("hizat", field_utctime_s_jiff().build());
        generate(Some("pg_gen_param_utctime_jiff"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # (insert) Param: Opt`<i32>`
    {
        ...
        generate(Some("pg_gen_param_opt_i32"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # (insert) Param: Opt`<i32>`, null
    {
        ...
        let hizat = bananna.field("hizat", field_i32().opt().build());
        generate(Some("pg_gen_param_opt_i32_null"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # (insert) Param: All custom types
    {
        ...
        generate(Some("pg_gen_param_custom"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # (insert) Param: Opt`<Custom>`
    {
        ...
        generate(Some("pg_gen_param_opt_custom"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Insert on conflict do nothing
    {
        ...
        generate(Some("pg_gen_insert_on_conflict_do_nothing"), vec![(1usize, v.build())], vec![
    ...
    // # Update
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_update"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Update, where
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_update_where"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Update, returning
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_update_returning"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Delete
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_delete"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Delete, where
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_delete_where"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Delete, returning
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_delete_returning"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Select limit
    {
        ...
        let hizat = bananna.field("hizat", field_str().build());
        generate(Some("pg_gen_select_limit"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Select order
    {
        ...
        let hizat = bananna.field("hizat", field_i32().build());
        generate(Some("pg_gen_select_order"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Select group
    {
        ...
        generate(Some("pg_gen_select_group_by"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Select CTE
    {
        ...
        generate(Some("pg_gen_select_cte"), vec![(1usize, v.build())], vec![]).unwrap();
    }
    ...
    // # Window function
    {
        ...
        let hizat = bananna.field("hizat", field_i32().build());
        let hizat2 = bananna.field("hizat2", field_i32().build());
        generate(Some("pg_gen_select_window"), vec![(1usize, v.build())], vec![]).unwrap();
    }
