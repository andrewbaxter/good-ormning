...
pub fn field_i16() -> FieldTypeBuilder { FieldTypeBuilder::new(crate::pg::types::type_i16().build()) }
...
pub fn field_u32() -> FieldTypeBuilder { FieldTypeBuilder::new(crate::pg::types::type_u32().build()) }
...
pub fn field_utctime_s_chrono() -> FieldTypeBuilder { FieldTypeBuilder::new(crate::pg::types::type_utctime_s_chrono().build()) }
pub fn field_utctime_ms_chrono() -> FieldTypeBuilder { FieldTypeBuilder::new(crate::pg::types::type_utctime_ms_chrono().build()) }
pub fn field_utctime_s_jiff() -> FieldTypeBuilder { FieldTypeBuilder::new(crate::pg::types::type_utctime_s_jiff().build()) }
pub fn field_utctime_ms_jiff() -> FieldTypeBuilder { FieldTypeBuilder::new(crate::pg::types::type_utctime_ms_jiff().build()) }
impl FieldTypeBuilder {
