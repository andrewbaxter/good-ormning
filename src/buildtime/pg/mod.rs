        ...
        match q.res_count {
            QueryResCount::None => {
                output.data.push(quote!{
                    ...
                    good_ormning:: runtime:: Error > {
                        db.execute(#q_text, &[#(& #args_forward,) *]).await ?;
                        Ok(())
                    }
                });
            },
            QueryResCount::MaybeOne => {
                ...
                output.data.push(quote!{
                    ...
                    good_ormning:: runtime:: Error > {
                        let r = db.query_opt(#q_text, &[#(& #args_forward,) *]).await ?;
                        if let Some(r) = r {
            ...
            QueryResCount::One => {
                ...
                output.data.push(quote!{
                    ...
                    good_ormning:: runtime:: Error > {
                        let r = db.query_one(#q_text, &[#(& #args_forward,) *]).await ?;
                        Ok(#unforward_res)
                    }
                });
            },
            QueryResCount::Many => {
                ...
                output.data.push(quote!{
                    ...
                    good_ormning:: runtime:: Error > {
                        let mut out = vec![];
                        for r in db.query(#q_text, &[#(& #args_forward,) *]).await ? {
